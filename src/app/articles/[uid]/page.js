...
function LatestArticle({ article }) {
  ...
  return (
    <li>
      <h1 className="mb-3 text-3xl font-semibold font-sans tracking-tighter text-slate-800 md:text-4xl">
  ...
  return (
    ...
    >
      <Bounded>
        <Link
          href="/"
          className="font-semibold font-sans tracking-tight text-slate-400"
        >
